        ...
        return(
            <div className="login-page">
                <Form className="login-form" onSubmit={this.handleSubmit}>
                    ...
                    <Input name="email" placeholder="Enter Email" onChange={this.handleChange} value={this.state.email}/>
                    </FormGroup>
                    <FormGroup>
                        <Label className="font-weight-bold">Pasword</Label>
                    <Input name="password" placeholder="Enter Password" onChange={this.handleChange} value={this.state.password}/>
                    </FormGroup>
                    <Button className="btn-lg btn-dark btn-block">Login</Button>
                    <div className="text-center pt-3 font-weight-bold">Or Continue with your social account!</div>
